-- Run this file after creating a new sqlite3 database on db/photoring.db
-- and populating a photos table with your data
-- Then you can run these sql commands with
--- sqlite3 db/photoring.db < create_metadata.sql
